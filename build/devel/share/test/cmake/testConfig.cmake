...
if("TRUE" STREQUAL "TRUE")
  set(test_SOURCE_PREFIX /home/torobo/test/src/test/hack19)
  set(test_DEVEL_PREFIX /home/torobo/test/src/test/hack19/build/devel)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'shimita <shimita@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/torobo/test/src/test/hack19/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/torobo/test/src/test/hack19/build/devel/lib;/opt/ros/melodic/lib)
